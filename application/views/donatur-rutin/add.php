                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Tambah Donatur Rutin</h2>
                                        <p>Menambahkan data <span class="bread-ntd">Donatur Rutin</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Donatur Rutin</h2>
                            <p>Menambahkan data donatur rutin.</p>
                        </div>
                        <div class="row">
                            <form method="post" action="<?php echo base_url('donatur_rutin/processAdd');?>"> 
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
