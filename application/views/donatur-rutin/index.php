                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Donatur Rutin</h2>
                                        <p>Daftar <span class="bread-ntd">Donatur Rutin</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                                <div class="breadcomb-report">
                                    ...
                                    <a href="<?php echo base_url('donatur_rutin/add');?>"><button class="btn notika-btn-primary">Tambah</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('donatur_rutin/edit/' . $value->idDonatur)?>">
                                                    <button class="btn btn-warning notika-btn-warning">Ubah</button>
                                                </a>
                                                <a href="<?php echo base_url('donatur_rutin/delete/' . $value->idDonatur . '/' . $value->idUser)?>">
                                                    <button class="btn btn-danger notika-btn-danger">Hapus</button>
                                                </a>
                                                <a href="<?php echo base_url('donatur_rutin/view/' . $value->idDonatur)?>">
