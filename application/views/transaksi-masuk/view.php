                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Lihat Transaksi Masuk</h2>
                                        <p>Melihat data <span class="bread-ntd">Transaksi Masuk detail</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Melihat data transaksi masuk detail.</p>
                        </div>
                        <div class="row">
                            <form> 
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <img src="<?php echo base_url('gambar/' . $transaksi->buktiBayar);?>" style="width: 150px;height: 150px;">
                                    <div class="form-group">
                                        <div class="nk-int-st">
